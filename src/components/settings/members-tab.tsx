        ...
        <div>
          ...
          {invitations.length > 0 ? (
            <p className="mb-3 text-xs text-muted-foreground">
              O link do convite é exibido apenas uma vez por segurança — para reenviar, revogue o convite abaixo e crie um novo.
            </p>
          ) : null}
          ...
          <DialogHeader>
            ...
            <DialogDescription className="text-muted-foreground">
              ...
              <span className="font-medium text-muted-foreground">
                {removingMember?.full_name || 'este colaborador'}
              </span>{' '}
              da conta? Ele será desconectado desta conta e receberá uma conta pessoal nova no próximo login. O login não será excluído.
            </DialogDescription>
          </DialogHeader>
