...
export function DealsSettings() {
  ...
  return (
    <section className="max-w-2xl animate-in fade-in-50 duration-200">
      <SettingsPanelHead
        title="Negócios & moeda"
        description="A moeda usada em novos negócios e nos totais do pipeline e dashboard."
      />
      <Card>
        <CardHeader>
          ...
          <CardDescription className="text-muted-foreground">
            Novos negócios usam esta moeda por padrão, e os totais do pipeline e dashboard são exibidos nela. Negócios existentes mantêm a moeda com que foram salvos.
          </CardDescription>
        </CardHeader>
