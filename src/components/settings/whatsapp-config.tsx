...
export function WhatsAppConfig() {
      ...
      if (data.registered === false && data.registration_error) {
        ...
        toast.success(
          data.phone_info?.verified_name
            ...
            : 'WhatsApp conectado. Os eventos começarão a fluir em instantes.',
        );
  ...
  async function handleReset() {
    if (!confirm('Isso excluirá a configuração atual do WhatsApp para que você possa reinserila. Continuar?')) {
      return;
    }
      ...
      <div className="space-y-6">
        ...
        <Alert className="bg-card border-border">
          ...
          <AlertDescription className="text-muted-foreground">
            {connectionStatus === 'connected'
              ? 'Seu token de acesso autentica com a Meta. Veja o status de registro abaixo para verificar se os webhooks estão conectados.'
              : statusMessage ||
          ...
          >
            <div className="flex items-center justify-between gap-2 flex-wrap">
              <div className="flex items-center gap-2">
                ...
                >
                  {isRegistered
                    ? 'Registrado — Meta entregará eventos ao DLX CRM'
            ...
            <AlertDescription className="text-muted-foreground mt-2 text-xs leading-relaxed">
              {isRegistered ? (
                ...
                <>
                  ...
                  . Insira (ou corrija) o PIN de 2 etapas abaixo e clique em Salvar Configuração para tentar novamente.
                </>
              ) : (
                <>
                  Este número foi salvo antes do rastreamento de registro existir, ou o registro foi ignorado. Insira o PIN de 2 etapas abaixo e clique em Salvar Configuração para inscrevê-lo.
                </>
              )}
            </AlertDescription>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription className="text-muted-foreground">
              Insira suas credenciais da API WhatsApp Business Meta.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Necessário apenas para conectar mensagens <strong className="text-muted-foreground">recebidas</strong> em um número de <strong className="text-muted-foreground">produção</strong>. Defina-o em{' '}
                <strong className="text-muted-foreground">
                  Meta Business Manager → Contas WhatsApp → Números de Telefone → Verificação em duas etapas
                </strong>
                , depois cole aqui para que o DLX CRM possa inscrever o número — caso contrário, a Meta envia eventos recebidos para o último app que o reclamou (o sintoma que afeta segundos números em um WABA compartilhado).{' '}
                <strong className="text-muted-foreground">Números de teste Meta</strong> não possuem PIN e são pré-registrados — deixe em branco para eles. Deixar em branco também mantém um registro existente intacto.
              </p>
            </div>
          </CardContent>
        </Card>
